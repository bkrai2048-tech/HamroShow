<script lang="ts">
    ...
    const freeshow_formats = [
        { name: "formats.show", title: "HamroShow Song/Presentation File", icon: "slide", extensions: ["show", "json"], id: "freeshow" },
        { name: "formats.project", title: "HamroShow Project File", icon: "project", extensions: ["project", "shows", "json", "zip"], id: "freeshow_project" }, // , "fsproject", "fsp"
        { name: "formats.template", title: "HamroShow Template File", icon: "templates", extensions: ["fstemplate", "fst", "template", "json", "zip"], id: "freeshow_template" },
        { name: "formats.action", title: "HamroShow Action File", icon: "actions", extensions: ["fsaction", "action", "json"], id: "freeshow_action" },
        { name: "formats.theme", title: "HamroShow Theme File", icon: "theme", extensions: ["fstheme", "theme", "json"], id: "freeshow_theme" }
    ]
